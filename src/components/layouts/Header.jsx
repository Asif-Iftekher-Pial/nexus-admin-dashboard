      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="hidden md:block">
            ...
            <p>Welcome back,Alex!! Heres what happened today</p>
          </div>
        </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-200
                rounded-xl text-slate-800 dark:text-white placeholder:text-slate-500 focus:outline-none
        ...
        <div className="flex items-center space-x-4">
          {/* quick action */}
          <button
            className="hidden lg:flex items-center space-x-2 py-2 px-4 bg-linear-to-r from-blue-500 to-purple-600 
